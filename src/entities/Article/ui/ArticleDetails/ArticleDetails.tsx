  ...
  if (isLoading) {
    ...
    content = (
      <ToggleFeatures
        ...
        on={<Text align='center' title={t('an error occurred while loading the article')} />}
        off={<TextDeprecated align={TextAlign.CENTER} title={t('an error occurred while loading the article')} />}
      />
    );
  } else {
